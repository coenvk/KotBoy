...
fun Byte.hexString(): String = "$${this.toString(16)}"
...
fun Byte.rr(bitCount: Int = 1): Byte = ((this ushr bitCount) or (this shl (Byte.SIZE_BITS - bitCount))).toByte()

fun Byte.rl(bitCount: Int = 1): Byte = ((this shl bitCount) or (this ushr (Byte.SIZE_BITS - bitCount))).toByte()
