...
class Cpu(private val gb: GameBoy) {
    ...
    */
    ...
    fun ld_36(vararg args: Int) = mmu.set(read(Reg16.HL), args[0])
    ...
    fun ld_fa(vararg args: Int) = write(Reg8.A, mmu.get(args.toWord()).toUnsignedInt())
    ...
    fun ld_ea(vararg args: Int) = mmu.set(args.toWord(), read(Reg8.A).toUnsignedInt())
    ...
    fun ldh_e0(vararg args: Int) =
        mmu.set(0xFF00 + args[0].toUnsignedInt(), read(Reg8.A).toUnsignedInt())

    fun ldh_f0(vararg args: Int) =
        write(Reg8.A, mmu[0xFF00 + args[0].toUnsignedInt()].toUnsignedInt())
    ...
    fun bit_46(vararg args: Int) = bit_b_r(0, mmu.get(read(Reg16.HL)).toByte())
    ...
    fun bit_4e(vararg args: Int) = bit_b_r(1, mmu.get(read(Reg16.HL)).toByte())
    ...
    fun bit_56(vararg args: Int) = bit_b_r(2, mmu.get(read(Reg16.HL)).toByte())
    ...
    fun bit_5e(vararg args: Int) = bit_b_r(3, mmu.get(read(Reg16.HL)).toByte())
    ...
    fun bit_66(vararg args: Int) = bit_b_r(4, mmu.get(read(Reg16.HL)).toByte())
    ...
    fun bit_6e(vararg args: Int) = bit_b_r(5, mmu.get(read(Reg16.HL)).toByte())
    ...
    fun bit_76(vararg args: Int) = bit_b_r(6, mmu.get(read(Reg16.HL)).toByte())
    ...
    fun bit_7e(vararg args: Int) = bit_b_r(7, mmu.get(read(Reg16.HL)).toByte())
